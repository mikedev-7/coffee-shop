        ...
        <section className="flex bg-primary h-[60vh] xl:h-[80vh]">
            ...
            <div className="flex-1 bg-opening_hours bg-cover bg-no-repeat flex  flex-col justify-center items-center relative">
                ...
                <div className="z-20 flex flex-col items-center justify-center">
                    ...
                    <Separator  bg="accent" />
                    <div className="mt-12 relative w-[300px] h-[220px] xl:w-[470px] xl:h-[200px]">
                        <Image src="/assets/opening-hours/program-badge.svg" fill  
                            className="object-contain" quality={100} priority alt=""
                        />
                    </div>
                </div>
            </div>
