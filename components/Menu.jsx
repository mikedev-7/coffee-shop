...
const menuItems = [
    {
     ...
     name : "Espresso",
     description: "Rich and bold taste of coffee",
     price: "3.3 "
    },
    {
                ...
                <div className='container mx-auto'>
                    <div className='flex flex-col gap-4 mb-12  xl:mb-24'>
                        ...
                        <p className='text-center max-w-[620px] mx-auto'>
                            ...
                            Maiores tempore dolorem eius eaque debitis iusto vel architecto, adipisci repudiandae repellat?
                        </p>
                    </div>
                    {/* menu & btn */}
